    ...
    <>
      <div className='flex items-center border-2 rounded-full py-2 md:shadow-sm'>
        <input
          ...
          className='text-[11px] sm:text-[12px] md:text-sm text-gray-600 placeholder-gray-400 flex-grow pl-2 sm:pl-3 md:pl-5  bg-transparent outline-none'
        />
        <SearchIcon className='hidden sm:inline-flex h-8 bg-red-400 text-white rounded-full p-2 cursor-pointer mx-2' />
      </div>
      {input && (
